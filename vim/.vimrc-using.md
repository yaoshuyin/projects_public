...
**nvim-gtk(不好用，不推荐)**
```console
apt install libgtk-3-dev cargo
cat > /root/.cargo/config <<_EOF_
[source.crates-io]
replace-with = 'tuna'
...
wget -c https://github.com/daa84/neovim-gtk/archive/v0.2.0.tar.gz
...
nmap <F6> :call MyGitCommit()<CR>
nmap <Leader>gc :call MyGitCommit()<CR>
